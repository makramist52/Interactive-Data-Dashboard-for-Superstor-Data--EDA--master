...
# (4) Now select the dates for which you want to show the Sales, as in dataset there is a col for order date
...
# (5) Now set the filters option on sidebar for which you want to dray bar chart & pie plot for sale
